...
Task: build a function C(X) that takes the feature vector X and predicts its value for Y , i.e. C(X) ∈ C

Models the probability that Y belongs to a particular category instead of Y directly
